...
{% macro default__base_select_renamed() %}
    ...
    , property_id
    , COALESCE({{ ga4.unnest_key('event_params', 'ga_session_id', 'int_value', 'session_id') }}, {{ ga4.unnest_key('event_params', 'ga_session_id', 'string_value', 'session_id_string') }}) as session_id
